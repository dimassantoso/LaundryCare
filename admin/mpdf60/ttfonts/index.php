                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Laundry Care</strong> Login</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="loginsubmit.php" method="post" class="login-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tipe" class="form-type form-control" id="tipe" required="required">
