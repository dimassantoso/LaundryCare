                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="myTable" class="js-dynamitable table table-bordered table-hover table-striped tablesorter" style="cursor: pointer;">
                                <thead>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-success" onclick="window.open('cetak_struk.php?id_order=<?php echo $id_order; ?>')"><span class="glyphicon glyphicon-print"></span> Cetak Struk</a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                   <?php 
